    ...
    try:
        ...
        <style>
            * {{ box-sizing: border-box; }}
            ...
            /* ### Änderung 3 von 3: Das neue CSS für den Regenbogen-Kreis ### */
            @keyframes spin {{
                from {{ transform: rotate(0deg); }}
                to {{ transform: rotate(360deg); }}
            }}
            .album-theme-active {{
                background: conic-gradient(from 180deg at 50% 50%, #FFC700 0deg, #FF0000 60deg, #DA00FF 120deg, #00B2FF 180deg, #00FF85 240deg, #F6FF00 300deg, #FFC700 360deg);
            }}
